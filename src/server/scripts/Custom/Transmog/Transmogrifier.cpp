    ...
    public:
        ...
        static bool OnGossipHello(Player* player, Creature* creature)
        {
            ...
            if (sTransmogrification->EnableTransmogInfo)
                AddGossipItemFor(player, GOSSIP_ICON_MONEY_BAG, (std::string("|TInterface/ICONS/INV_Misc_Book_11:30:30:-18:0|t") + GTS(LANG_MENU_HOW_TRANSMOG_WORKS)).c_str(), EQUIPMENT_SLOT_END + 9, 0);
            ...
            if (sTransmogrification->EnableSets)
                AddGossipItemFor(player, GOSSIP_ICON_MONEY_BAG, (std::string("|TInterface/RAIDFRAME/UI-RAIDFRAME-MAINASSIST:30:30:-18:0|t") + GTS(LANG_MENU_MANAGE_SETS)).c_str(), EQUIPMENT_SLOT_END + 4, 0);
#endif
            AddGossipItemFor(player, GOSSIP_ICON_MONEY_BAG, (std::string("|TInterface/ICONS/INV_Enchant_Disenchant:30:30:-18:0|t") + GTS(LANG_MENU_REMOVE_ALL_TRANSMOG)).c_str(), EQUIPMENT_SLOT_END + 2, 0,
                             GTS(LANG_CONFIRM_REMOVE_ALL_TRANSMOG), 0, false);
            AddGossipItemFor(player, GOSSIP_ICON_MONEY_BAG, (std::string("|TInterface/PaperDollInfoFrame/UI-GearManager-Undo:30:30:-18:0|t") + GTS(LANG_MENU_UPDATE)).c_str(), EQUIPMENT_SLOT_END + 1, 0);
                ...
                case EQUIPMENT_SLOT_END + 4: // Presets menu
                    {
                        ...
                        if (sTransmogrification->EnableSetInfo)
                            AddGossipItemFor(player, GOSSIP_ICON_MONEY_BAG, (std::string("|TInterface/ICONS/INV_Misc_Book_11:30:30:-18:0|t") + GTS(LANG_MENU_HOW_SETS_WORK)).c_str(), EQUIPMENT_SLOT_END + 10, 0);
                        ...
                        if (!player->presetMap.empty())
                        {
                            ...
                            if (player->presetMap.size() < sTransmogrification->MaxSets)
                                AddGossipItemFor(player, GOSSIP_ICON_MONEY_BAG, (std::string("|TInterface/GuildBankFrame/UI-GuildBankFrame-NewTab:30:30:-18:0|t") + GTS(LANG_MENU_SAVE_SET)).c_str(), EQUIPMENT_SLOT_END + 8, 0);
                        }
                        else
                            AddGossipItemFor(player, GOSSIP_ICON_MONEY_BAG, (std::string("|TInterface/GuildBankFrame/UI-GuildBankFrame-NewTab:30:30:-18:0|t") + GTS(LANG_MENU_SAVE_SET)).c_str(), EQUIPMENT_SLOT_END + 8, 0);
                        AddGossipItemFor(player, GOSSIP_ICON_MONEY_BAG, (std::string("|TInterface/ICONS/Ability_Spy:30:30:-18:0|t") + GTS(LANG_MENU_BACK)).c_str(), EQUIPMENT_SLOT_END + 1, 0);
                        SendGossipMenuFor(player, DEFAULT_GOSSIP_MESSAGE, creature->GetGUID());
                    } break;
                ...
                case EQUIPMENT_SLOT_END + 6: // view preset
                    {
                        ...
                        AddGossipItemFor(player, GOSSIP_ICON_MONEY_BAG, (std::string("|TInterface/ICONS/Ability_Spy:30:30:-18:0|t") + GTS(LANG_MENU_BACK)).c_str(), EQUIPMENT_SLOT_END + 4, 0);
                        SendGossipMenuFor(player, DEFAULT_GOSSIP_MESSAGE, creature->GetGUID());
                    } break;
        ...
        static void ShowTransmogItems(Player* player, Creature* creature, uint8 slot) // Only checks bags while can use an item from anywhere in inventory
        {
            ...
            AddGossipItemFor(player, GOSSIP_ICON_MONEY_BAG, (std::string("|TInterface/ICONS/INV_Enchant_Disenchant:30:30:-18:0|t") + GTS(LANG_MENU_REMOVE_TRANSMOG)).c_str(), EQUIPMENT_SLOT_END + 3, slot, GTS(LANG_CONFIRM_REMOVE_TRANSMOG), 0, false);
            AddGossipItemFor(player, GOSSIP_ICON_MONEY_BAG, (std::string("|TInterface/PaperDollInfoFrame/UI-GearManager-Undo:30:30:-18:0|t") + GTS(LANG_MENU_UPDATE)).c_str(), EQUIPMENT_SLOT_END, slot);
            AddGossipItemFor(player, GOSSIP_ICON_MONEY_BAG, (std::string("|TInterface/ICONS/Ability_Spy:30:30:-18:0|t") + GTS(LANG_MENU_BACK)).c_str(), EQUIPMENT_SLOT_END + 1, 0);
            SendGossipMenuFor(player, DEFAULT_GOSSIP_MESSAGE, creature->GetGUID());
        }
    };
