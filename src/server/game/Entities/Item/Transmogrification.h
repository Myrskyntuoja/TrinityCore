...
enum TransmogTrinityStrings // Language.h might have same entries, appears when executing SQL, change if needed
{
    ...
    LANG_MENU_HOW_TRANSMOG_WORKS = 11112,
    LANG_SLOT_NAME_HEAD,
    ...
    LANG_MENU_MANAGE_SETS,
    LANG_MENU_REMOVE_ALL_TRANSMOG,
    LANG_CONFIRM_REMOVE_ALL_TRANSMOG,
    LANG_MENU_UPDATE,
    LANG_MENU_HOW_SETS_WORK,
    LANG_MENU_SAVE_SET,
    LANG_MENU_BACK,
    LANG_MENU_REMOVE_TRANSMOG,
    LANG_CONFIRM_REMOVE_TRANSMOG
};
